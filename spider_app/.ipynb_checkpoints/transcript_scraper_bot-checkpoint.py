...
import pandas as pd
import random
import spider.spiderSettings as ss
user_agent_list = [
   #Chrome
...
class QuotesSpider(scrapy.Spider):
    ...
    custom_settings = {
            'LOG_ENABLED': False,
            'DOWNLOAD_DELAY': ss.DOWNLOAD_DELAY # 0.25 == 250 ms of delay, 1 == 1000ms of delay, etc.
    }
    tickers=[]
